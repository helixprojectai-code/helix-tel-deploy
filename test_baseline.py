...
async def test_model(model: str, api_key: str):
    ...
    try:
        ...
        return {"model": model, "c_seed": split.c_seed, "vector": vector, "substrate": split.substrate}
...
async def main():
    ...
    print(f"Legacy unversioned seed                    : 16ce8df91c0d04baf63f6a4b3f3471251c8b012dcf78e0a09b6183ec54cbed72")
    print(f"{'='*60}")
